// src/components/CalendarGridWeek.tsx
    ...
    <>
      ...
      {Array.from({ length: 7 }).map((_, dayIndex) => {
        ...
        const blockHereIndex = blocks.findIndex((b) => {
          ...
          return (
            blockDate.toDateString() === cellDate.toDateString() &&
        ...
        const textColor = blockHere ? getTextColorForBackground(blockHere.color) : undefined;
        ...
        return (
          <div
            ...
            style={{
              backgroundColor: blockHere?.color,
              color: textColor,
              borderRadius: blockHere ? "8px" : undefined,
            }}
          >
            {blockHere && (
              <>
                ...
                >
                  <button
                    onClick={() => onEdit?.(blockHereIndex)}
                    style={{ background: "none", border: "none", color: textColor }}
                  >
                    <Edit2 size={14} />
                  </button>
                  <button
                    onClick={() => onDelete?.(blockHereIndex)}
                    style={{ background: "none", border: "none", color: textColor }}
                  >
                    <Trash2 size={14} />
                  </button>
